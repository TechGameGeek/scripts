...
main() {
    ...
    while true; do
        read -p "Bitte wählen Sie die Nummer des zu deinstallierenden Kernels (9 zum Beenden): " choice
        ...
        if [ "$choice" -eq 9 ]; then
            ...
            echo "Ungültige Auswahl. Bitte wählen Sie eine gültige Nummer oder 9 zum Beenden."
        fi
    done
}
